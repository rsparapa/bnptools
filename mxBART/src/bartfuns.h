...
//--------------------------------------------------
//birth proposal
void bprop(tree& x, xinfo& xi, pinfo& pi, tree::npv& goodbots, double& PBx, tree::tree_p& nx, size_t& v, size_t& c, double& pr, std::vector<double>& pv, std::vector<size_t>& nv, bool aug, rn& gen);
//--------------------------------------------------
// death proposal
