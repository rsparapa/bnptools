...
Map<Matrix<double,Dynamic,Dynamic,RowMajor> > beta(ibeta.data(),p+1,1);
  Map<Matrix<double,Dynamic,Dynamic,RowMajor> > propV(ipropV.data(),p+1,p+1);
