...
yhat.test2=HDFPD(post, x.train, x.test, 3, mult.impute=20)
...
lines(x, yhat.test2.mean, col=2, lty=1, lwd=2)
lines(x, yhat.test2.025, col=2, lty=3, lwd=2)
lines(x, yhat.test2.975, col=2, lty=3, lwd=2)
legend('topleft', col=c(4, 1, 2), lty=1,
       legend=c('True', 'FPD', '20'), lwd=2)
